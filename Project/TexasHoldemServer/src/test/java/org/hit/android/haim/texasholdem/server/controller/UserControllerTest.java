 ...
 public class UserControllerTest {
    ...
    void tearDown() {
       String myId = "myId";
       if (userService.existsById(myId)) {
          userService.deleteById(myId);
       }
       userService.deleteById("charmander@pokemon.com");
       userService.deleteById("charizard@pokemon.com");
    ...
    void testSignUp_userAlreadyExists_signUpFail() throws Exception {
       UserImpl userToCreate = new UserImpl("charmander@pokemon.com", "pass".toCharArray(), "nameForTest",
    ...
    void testUserInfo_correctUserToken_success() throws Exception {
       ...
       MvcResult response = mockMvc
             .perform(post("/user/signin").secure(true).contentType(APPLICATION_JSON_UTF8).content(json))
             .andExpect(status().isOk())
             .andReturn();

       // Second, test.
       mockMvc
             .perform(get("/user/charizard@pokemon.com/info").secure(true).header(AUTHORIZATION_HEADER,
                   TestUtils.getJwtTokenFromMvcResult(response)))
             .andExpect(status().isOk())
